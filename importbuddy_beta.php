...
class pluginbuddy_importbuddy {
	...
	function migrate_database() {
		...
		if ( isset( $this->_backupdata['is_multisite'] ) && ( ( $this->_backupdata['is_multisite'] === true ) || ( $this->_backupdata['is_multisite'] == 'true' ) ) ) { // TODO: String 'true' comparison can be removed later. Added for backward compatibility with importbuddy 2.0 beta.
		...
		if ( isset( $this->_backupdata[ 'is_multisite_export' ] ) && ( ( $this->_backupdata[ 'is_multisite_export' ] == true ) || ( $this->_backupdata[ 'is_multisite_export' ] == 'true' ) ) ) {
			if ( isset( $this->_backupdata[ 'upload_url' ] ) && isset( $this->_backupdata[ 'upload_url_rewrite' ] ) ) {
