	...
	/* WGA i think I should remove this function */
		...
		*/
		...
		function site_admin_menu() {
			...
			add_menu_page( $this->_parent->_name, $this->_parent->_name, 'administrator', $this->_parent->_var, array( &$this, 'view_msgettingstarted' ), $this->_parent->_pluginURL.'/images/pluginbuddy.png');
		...
		function admin_menu() {
			...
			*/
			if ( isset( $this->_parent->_series ) && ( $this->_parent->_series != '' ) ) {
				...
				// Add main menu (default when clicking top of menu)
				add_menu_page( $this->_parent->_name, $this->_parent->_name, $role, $this->_parent->_var, array( &$this, 'view_gettingstarted' ), $this->_parent->_pluginURL.'/images/pluginbuddy.png');
				// Add sub-menu items (first should match default page above)
